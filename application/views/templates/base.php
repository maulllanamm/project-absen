<head>
    ...
    <link href="<?php echo config_item('assets'); ?>mt/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo config_item('assets'); ?>mt/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo config_item('assets'); ?>mt/toastr/toastr.min.css">

    <link rel="shortcut icon" href="<?php echo config_item('assets'); ?>aseanAssets/aseranLogo2.png" />
    <link rel="stylesheet" href="<?php echo config_item('assets'); ?>mt/css/custom-v1.css">
