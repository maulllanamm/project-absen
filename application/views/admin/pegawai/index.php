                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td width="15%">
                          <a href="javascript:void(0)" data-toggle="modal" class="btn btn-outline-brand btn-sm "   data-id_peg="<?= $row->id;?>" data-nama="<?= $row->nama_pegawai;?>" data-alamat="<?= $row->alamat;?>" onmouseover="over()" data-toggle="tooltip" title="Ubah Kurir" id="btn-edit" >
