        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
          ...
          <div class="kt-container kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet kt-portlet--mobile">
              ...
              <form class="controls" role="form" action="<?= base_url('karyawan/update_kegiatan') ?>" method="post">
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <input name="nama_kegiatan" value="<?= $kegiatan['0']['nama_pegawai']; ?>"  class="form-control" type="text" readonly=""/>
                    </div>
                   <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <textarea name="rincian" value=""  class="form-control" type="text"/></textarea>
                    </div>

                    <div class="form-group col-sm-6">
                      <label>Upload Bukti Surat Kegiatan</label>
                      <input name="surat" value=""  class="form-control" type="file"/>
                    </div>
                  </div> 
                </div>
                <div class="modal-footer"> 
                  <button type="submit" class="btn btn-primary">Upload</button> <button type="reset"class="btn btn-secondary" data-dismiss="modal">Back</button> 
                </div> 
                </form>
              </div>
              </div>
