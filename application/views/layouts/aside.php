    ...
    <div class="kt-aside__brand kt-grid__item id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="{{url('/dashboard')}}">
                <img alt="Logo" src="{{asset('logos/footer-logo.png')}}" width="auto;" height="40px;" />
            </a>
        </div>
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                       ...
                       <!-- <li class="kt-menu__item {{ $page == 'ProdcutsCategory' || $page == 'Products' ? 'kt-menu__item--open' : '' }} kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            ...
                            <div class="kt-menu__submenu ">
                                ...
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item @if($page == 'ProdcutsCategory'){{'kt-menu__item--active'}}@endif" aria-haspopup="true">
                                        <a href="{{url('/dashboard/products-category')}}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                            <span class="kt-menu__link-text">Products Category</span>
                                        </a>
                                    </li>
                                    <li class="kt-menu__item @if($page == 'Products'){{'kt-menu__item--active'}}@endif" aria-haspopup="true">
                                        <a href="{{url('/dashboard/products')}}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                            <span class="kt-menu__link-text">Products</span>
                                        </a>
                                    </li>
                        ...
                        <li class="kt-menu__item @if($page == 'Events'){{'kt-menu__item--active'}}@endif" aria-haspopup="true">
                            <a href="{{url('/dashboard/events')}}" class="kt-menu__link ">
                                <span class="kt-menu__link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <li class="kt-menu__item {{ $page == 'News' || $page == 'ManageTags' ? 'kt-menu__item--open' : '' }} kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <span class="kt-menu__link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="kt-menu__submenu ">
                                ...
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item @if($page == 'ManageTags'){{'kt-menu__item--active'}}@endif" aria-haspopup="true">
                                        <a href="{{url('/dashboard/tags')}}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                            <span class="kt-menu__link-text">Manage Tags</span>
                                        </a>
                                    </li>
                                    <li class="kt-menu__item @if($page == 'News'){{'kt-menu__item--active'}}@endif" aria-haspopup="true">
                                        <a href="{{url('/dashboard/news')}}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                            <span class="kt-menu__link-text">News</span>
                                        </a>
                                    </li>
